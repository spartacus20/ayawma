...
function EmailModal({ emailModal, toggleModal }) {
    return (
        <>
            ...
            <div id="defaultModal" tabIndex="-1" aria-hidden="true" className={emailModal ? "flex  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full sm:mt-[150px] xl:mt-[0px]" : "hidden"}>
