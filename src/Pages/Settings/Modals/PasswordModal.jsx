...
function PasswordModal({ passwordModal, toggleModal }) {
    return (
        ...
        <>
            ...
            <div id="defaultModal" tabIndex="-1" aria-hidden="true" className={passwordModal ? "flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full" : "hidden"}>
                        ...
                        <form action="#">
                            <div className="flex w-full mb-5 flex-col">
                                <div className='w-full mb-4'>
                                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Old password</label>
                                ...
                                <div className='w-full mb-4'>
                                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Repeat New password</label>
                                    <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Your name" required="" />
                                </div>
                            </div>
