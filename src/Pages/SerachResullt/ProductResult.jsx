      ...
      <div className="w-full h-screen flex flex-col  ">
        ...
        <div className="w-[100%] h-[85%] 2xl:flex-row  sm:flex sm:flex-col" >
          ...
          <div className="2xl:w-[80%] 2xl:mt-[20px] h-[100%] xl:w-[80%] lg:w-[80%] sm:w-[100%] sm:mt-[0px] ">
            <div className="w-full h-[45px] border-2 border-black flex ">
              <h3 className="font-semibold text-left">find result: "controller"</h3>
              <div>
                <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                onClick={() => setDropDown(!dropdown)}
                class="2xl:ml-[850px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Filter <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
